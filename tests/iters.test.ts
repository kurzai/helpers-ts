...
describe("iters", () => {
    it("increases the counter to 6", async () => {
    ...
    it("adds up all the numbers of the array to 21", async () => {
        let counter: number = 0;
        const arr: number[] = [1, 2, 3, 4, 5, 6];
    ...
    it("returns an array with only even numbers", async () => {
        const arr: number[] = [1, 2, 3, 4, 5, 6];
    ...
    it("returns an array with doubled numbers", async () => {
        const arr: number[] = [1, 2, 3, 4, 5, 6];
    ...
    it("finds the item with value 4", async () => {
        const arr: number[] = [1, 2, 3, 4, 5, 6];
